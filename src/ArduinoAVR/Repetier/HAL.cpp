...
const uint16_t slow_div_lut[257] PROGMEM = {0,(uint16_t)(F_CPU/32),(uint16_t)(F_CPU/64),(uint16_t)(F_CPU/96),(uint16_t)(F_CPU/128),(uint16_t)(F_CPU/160),(uint16_t)(F_CPU/192),(uint16_t)(F_CPU/224),F_CPU/256,F_CPU/288,F_CPU/320,F_CPU/352
